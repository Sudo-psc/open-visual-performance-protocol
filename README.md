...
OVPP is designed to sit beside the book:
...
Organizations use OVPP when they want to:
...
Current repository standard: **10/10 against the product-companion rubric**.

That score means the repo now has:
